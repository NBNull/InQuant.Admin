...
namespace InQuant.Framework.Modules
{
    public static class ModuleManager
    {
        ...
        public static IList<Assembly> GetAllModules()
        {
            if (_allModules == null)
            {
                ...
                _allModules = Directory.GetFiles(dllFolder, "InQuant*.dll")
        ...
        public static IServiceCollection AddModules(this IServiceCollection services)
        {
            ...
            foreach (var m in svrs)
            {
                ...
                {
                    if (i.Namespace != null && i.Namespace.StartsWith("InQuant", StringComparison.CurrentCultureIgnoreCase))
                    {
                        if (i.IsGenericType)
                        {
